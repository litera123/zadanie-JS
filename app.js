...
function obliczanie(dane) {
    ...
    if( dane.vat[0].checked){
        cena_koncowa=cena_koncowa;
    }
    if( dane.vat[1].checked){
        cena_koncowa*=parseFloat(dane.vat[1].value)
    }
    if( dane.vat[2].checked){
        cena_koncowa*=parseFloat(dane.vat[2].value)
    }
    ...
    cena.innerHTML = cena_koncowa.toFixed(2) + " pln";
